...
class StrategyRegressionTests(unittest.TestCase):
    ...
    def test_weather_strategy_prefers_yes_side_when_yes_edge_is_best(self, _mock_threshold):
    ...
    @patch.object(Strategy, "_get_edge_threshold", return_value=0.0)
    def test_weather_strategy_uses_no_side_probability_and_kelly(self, _mock_threshold):
        strategy = self._build_strategy(
            probability=0.20,
            distribution={
