...
NO_SEPARATION_FLOOR_F = 3.0
NO_SEPARATION_STD_DEV_MULT = 0.8
MAX_MODEL_DIVERGENCE_YES_F = 6
MAX_MODEL_DIVERGENCE_NO_F = 8
MODEL_CONVERGENCE_BOOST_F = 2
CONFIRM_NO_SEPARATION_PENALTY = 1.5
