...
PAPER_CHALLENGER_MIN_FEE_ADJ_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_MIN_FEE_ADJ_EDGE", "0.05")
)
...
PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_FEE_ADJ_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_FEE_ADJ_EDGE", "0.08")
)
PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_EDGE", "0.12")
)
...
PAPER_CHALLENGER_SOFT_LOCK_MIN_LOCAL_HOUR = int(
    os.environ.get("PAPER_CHALLENGER_SOFT_LOCK_MIN_LOCAL_HOUR", "10")
)
...
PAPER_CHALLENGER_SOFT_LOCK_BUFFER_F = float(
    os.environ.get("PAPER_CHALLENGER_SOFT_LOCK_BUFFER_F", "0.5")
)
...
PAPER_CHALLENGER_S7_MAX_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_S7_MAX_PRICE_CENTS", "60")
)
PAPER_CHALLENGER_S7_MIN_LOCAL_HOUR = int(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_LOCAL_HOUR", "14")
)
PAPER_CHALLENGER_S7_MIN_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_EDGE", "0.06")
)
PAPER_CHALLENGER_S7_MIN_FEE_ADJ_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_FEE_ADJ_EDGE", "0.03")
)
