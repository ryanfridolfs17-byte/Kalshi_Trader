...
ENABLE_OBSERVATION_CHALLENGER_STRATEGIES = os.environ.get(
...
PAPER_STRATEGY_RELAX_FILTERS = os.environ.get(
    "PAPER_STRATEGY_RELAX_FILTERS",
    "true"
).lower() == "true"
PAPER_IGNORE_LEARNING_BLOCKS = os.environ.get(
    "PAPER_IGNORE_LEARNING_BLOCKS",
    "true"
).lower() == "true"
PAPER_ALLOW_BEFORE_6AM_DIRECTIONAL_TRADES = os.environ.get(
    "PAPER_ALLOW_BEFORE_6AM_DIRECTIONAL_TRADES",
    "true"
).lower() == "true"
PAPER_ALLOW_BEFORE_NOON_DIRECTIONAL_TRADES = os.environ.get(
    "PAPER_ALLOW_BEFORE_NOON_DIRECTIONAL_TRADES",
    "true"
).lower() == "true"
PAPER_ALLOW_NEXT_DAY_DIRECTIONAL_TRADES = os.environ.get(
    "PAPER_ALLOW_NEXT_DAY_DIRECTIONAL_TRADES",
    "true"
).lower() == "true"
PAPER_ALLOW_THRESHOLD_DIRECTIONAL_TRADES = os.environ.get(
    "PAPER_ALLOW_THRESHOLD_DIRECTIONAL_TRADES",
    "true"
).lower() == "true"
PAPER_ALLOW_YES_SIDE_TRADES = os.environ.get(
    "PAPER_ALLOW_YES_SIDE_TRADES",
    "true"
).lower() == "true"
PAPER_ALLOW_STRONG_VERDICTS = os.environ.get(
    "PAPER_ALLOW_STRONG_VERDICTS",
    "true"
).lower() == "true"
PAPER_IGNORE_NO_SIDE_GUARDS = os.environ.get(
    "PAPER_IGNORE_NO_SIDE_GUARDS",
    "true"
).lower() == "true"
PAPER_IGNORE_ROUNDING_BUFFER = os.environ.get(
    "PAPER_IGNORE_ROUNDING_BUFFER",
    "true"
).lower() == "true"
PAPER_EDGE_THRESHOLD_MULTIPLIER = float(
    os.environ.get("PAPER_EDGE_THRESHOLD_MULTIPLIER", "0.5")
)
PAPER_FEE_ADJ_MIN_EDGE = float(
    os.environ.get("PAPER_FEE_ADJ_MIN_EDGE", "0.01")
)
PAPER_LONGSHOT_FLOOR_CENTS = int(
    os.environ.get("PAPER_LONGSHOT_FLOOR_CENTS", "10")
)
PAPER_NEAR_CERTAINTY_CAP_CENTS = int(
    os.environ.get("PAPER_NEAR_CERTAINTY_CAP_CENTS", "95")
)
PAPER_MAX_MODEL_DIVERGENCE_YES_F = float(
    os.environ.get("PAPER_MAX_MODEL_DIVERGENCE_YES_F", "12")
)
PAPER_MAX_MODEL_DIVERGENCE_NO_F = float(
    os.environ.get("PAPER_MAX_MODEL_DIVERGENCE_NO_F", "15")
)
...
PAPER_CHALLENGER_MAX_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_MAX_PRICE_CENTS", "80")
)
PAPER_CHALLENGER_MIN_FEE_ADJ_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_MIN_FEE_ADJ_EDGE", "0.02")
)
...
PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_PRICE_CENTS", "48")
)
PAPER_CHALLENGER_TIGHT_NEXT_DAY_MAX_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_TIGHT_NEXT_DAY_MAX_PRICE_CENTS", "66")
)
PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_FEE_ADJ_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_FEE_ADJ_EDGE", "0.04")
)
PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_TIGHT_NEXT_DAY_MIN_EDGE", "0.06")
)
PAPER_CHALLENGER_ALLOW_SOFT_SETTLEMENT_LOCK = os.environ.get(
    "PAPER_CHALLENGER_ALLOW_SOFT_SETTLEMENT_LOCK",
    "true"
).lower() == "true"
...
PAPER_STRATEGY_AUTOKILL_MIN_PROFIT_FACTOR = float(
    os.environ.get("PAPER_STRATEGY_AUTOKILL_MIN_PROFIT_FACTOR", "1.0")
)
PAPER_STRATEGY_AUTOKILL_MIN_EXPECTANCY_CENTS = float(
    os.environ.get("PAPER_STRATEGY_AUTOKILL_MIN_EXPECTANCY_CENTS", "0")
)
PAPER_STRATEGY_STATUS_CACHE_SECONDS = int(
    os.environ.get("PAPER_STRATEGY_STATUS_CACHE_SECONDS", "300")
)
PAPER_CHALLENGER_SOFT_LOCK_MIN_LOCAL_HOUR = int(
    os.environ.get("PAPER_CHALLENGER_SOFT_LOCK_MIN_LOCAL_HOUR", "9")
)
PAPER_CHALLENGER_SOFT_LOCK_MAX_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_SOFT_LOCK_MAX_PRICE_CENTS", "85")
)
PAPER_CHALLENGER_SOFT_LOCK_BUFFER_F = float(
    os.environ.get("PAPER_CHALLENGER_SOFT_LOCK_BUFFER_F", "0.25")
)
# S7 Afternoon NO Sweet Spot
PAPER_CHALLENGER_ALLOW_AFTERNOON_NO_SWEET_SPOT = os.environ.get(
    "PAPER_CHALLENGER_ALLOW_AFTERNOON_NO_SWEET_SPOT",
    "true"
).lower() == "true"
PAPER_CHALLENGER_S7_MIN_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_PRICE_CENTS", "35")
)
PAPER_CHALLENGER_S7_MAX_PRICE_CENTS = int(
    os.environ.get("PAPER_CHALLENGER_S7_MAX_PRICE_CENTS", "70")
)
PAPER_CHALLENGER_S7_MIN_LOCAL_HOUR = int(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_LOCAL_HOUR", "12")
)
PAPER_CHALLENGER_S7_MIN_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_EDGE", "0.03")
)
PAPER_CHALLENGER_S7_MIN_FEE_ADJ_EDGE = float(
    os.environ.get("PAPER_CHALLENGER_S7_MIN_FEE_ADJ_EDGE", "0.01")
)
