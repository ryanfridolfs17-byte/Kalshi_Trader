...
SEASONAL_MATRIX = {
    ...
    "MIA": [1.10, 0.80, 1.05, 1.00, 0.90, 0.80, 0.85, 0.85, 0.75, 0.90, 1.05, 1.10],  # Feb: 1.10→0.80 (warm front unpredictability, lost $22 on MIA Feb)
    "AUS": [0.85, 0.70, 0.82, 0.88, 0.90, 1.00, 1.15, 1.15, 0.90, 0.80, 0.85, 0.85],  # Feb: 0.80→0.70 (lost $22 on AUS Feb)
    ...
    "ATL": [0.95, 0.75, 0.83, 0.88, 0.90, 0.90, 0.95, 0.95, 0.85, 0.90, 0.95, 0.95],  # Feb: 0.90→0.75 (warm front volatility)
    "BOS": [1.05, 1.00, 0.83, 0.88, 0.90, 0.95, 1.05, 1.00, 0.85, 0.85, 0.95, 1.05],  # Maritime NE, similar to NYC
    "DAL": [0.85, 0.70, 0.82, 0.88, 0.90, 1.00, 1.10, 1.10, 0.90, 0.80, 0.85, 0.85],  # Feb: 0.80→0.70 (lost $14 on DAL Feb)
    "DC":  [1.00, 0.95, 0.83, 0.88, 0.95, 0.95, 1.05, 1.00, 0.85, 0.85, 0.95, 1.00],  # Mid-Atlantic transitional
    "HOU": [0.90, 0.75, 0.87, 0.87, 0.90, 0.90, 0.95, 0.95, 0.80, 0.85, 0.90, 0.90],  # Feb: 0.85→0.75 (Gulf coast warm front)
    ...
    "NOLA":[0.90, 0.75, 0.87, 0.90, 0.90, 0.85, 0.90, 0.90, 0.80, 0.90, 0.90, 0.90],  # Feb: 0.85→0.75 (Gulf coast like HOU)
    ...
    "SATX":[0.85, 0.70, 0.82, 0.88, 0.90, 1.00, 1.10, 1.10, 0.90, 0.80, 0.85, 0.85],  # Feb: 0.80→0.70 (similar to AUS)
